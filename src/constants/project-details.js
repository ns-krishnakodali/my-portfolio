...
export const PROJECTS_DETAILS = [
  {
    ...
    description: 'An agentic AI platform for personal portfolio management.',
  ...
  },
  {
    ...
    description: 'Real-time online multiplayer implementation of Exploding Kittens.',
    techstack: ['Javascript', 'React', 'Firebase'],
    githubLink: 'https://github.com/ns-krishnakodali/exploding-kittens',
    categories: 'se',
  },
  {
    title: 'Email Server',
